import { Link } from "react-router-dom"
  ...
  export default function HeaderGraphic() {
    return (
      <>
      <section class="bg-center bg-no-repeat bg-cover bg-[url('https://plus.unsplash.com/premium_photo-1661281412140-dfb328ae967b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Z3JhcGhpYyUyMGRlc2lnbnxlbnwwfHwwfHx8MA%3D%3D')] bg-gray-700 bg-blend-multiply">
<div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
<h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Graphic Design</h1>
