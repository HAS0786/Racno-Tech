import { Link } from "react-router-dom"
  ...
  export default function HeaderWebsite() {
    return (
      <>
      <section class="bg-center bg-no-repeat bg-cover bg-[url('https://cdn.pixabay.com/photo/2015/06/24/15/45/code-820275_640.jpg')] bg-gray-700 bg-blend-multiply">
<div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
<h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">Web/App Development</h1>
